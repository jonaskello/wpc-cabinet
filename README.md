...
The sketchup file is [here](https://github.com/jonaskello/wpc-cabinet/archive/0.1.0.zip). You need to unzip it and find the file WPC_Cabinet.skp and open it in Sketchup.
